...
**Figure of Merit Trend Plot**: The plot below shows the improvement in $FOM_S$ over time. The blue line is for the horizontal (low-frequency) asymptote in the Figure of Merit Plot. The red curve is for the high-frequency asymptote, evaluated at 1 GHz. We observe that low-speed designs are just a few decibels away from the classical $8kT$ x $SNR$ limit for an ideal class-B analog circuit. The $FOM_S$ improvement rate for both high- and low-speed designs has been in the range of 1-2 dB.
